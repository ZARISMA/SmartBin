"""
hexabin/edge_client.py — HTTP client for edge-to-server communication.
...
def _detect_local_host() -> str:
    ...
    override = os.environ.get("HEXABIN_EDGE_HOST", "").strip()
    if override:
...
def classify_remote(
    ...
    """
    if not SERVER_URL:
        raise EdgeServerError("HEXABIN_SERVER_URL is not configured")
