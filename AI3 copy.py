...
CAPTURE_INTERVAL = 7  # seconds (change to 4 for 4 sec)

last_label = "Detecting..."
VALID_CLASSES = ["Plastic", "Paper", "Aluminum", "Empty"]
    ...
    try:
        response = model.generate_content([
            ...
            {"text": (
                ...
                "Return EXACTLY one of these words: Plastic,  Paper, Aluminum, Other, Empty.\n\n"
